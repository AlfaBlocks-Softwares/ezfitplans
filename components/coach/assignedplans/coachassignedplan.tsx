...
import EnhancedAssignedPlansTable from "./table";
...
export default function CoachAssignedPlan() {
  return (
    <section className="w-full h-full rounded-lg bg-primary p-4 flex flex-col gap-4 justify-start items-center my-3 min-h-[88dvh]">
      ...
      <div className="w-full h-full flex flex-col gap-4 justify-start items-center">
        <EnhancedAssignedPlansTable plans={dummyPlans} />
      </div>
    </section>
  );
}
